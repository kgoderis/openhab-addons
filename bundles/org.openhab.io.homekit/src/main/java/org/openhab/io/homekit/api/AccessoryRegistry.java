...
/**
 * {@link AccessoryRegistry} tracks all {@link ManagedAccessory}s from different {@link AccessoryProvider}s and provides access
...
@NonNullByDefault
public interface AccessoryRegistry extends Registry<ManagedAccessory, AccessoryUID> {
     ...
     */
    Collection<ManagedAccessory> get(String serverId);
