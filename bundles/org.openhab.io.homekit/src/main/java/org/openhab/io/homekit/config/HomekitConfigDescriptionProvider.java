    ...
    private ConfigDescription createConfigDescription() {
        return ConfigDescriptionBuilder.create(CONFIG_URI)
            .withParameter(ConfigDescriptionParameterBuilder.create("item.enabled", Type.BOOLEAN)
                .withLabel("Item Enabled")
                .withDescription("Enable/disable HomeKit integration for an item")
                .withDefault("true")
                .build())
            .withParameter(ConfigDescriptionParameterBuilder.create("item.type", Type.TEXT)
                .withLabel("Item Type")
                .withDescription("The HomeKit type for this item")
                .build())
            .withParameter(ConfigDescriptionParameterBuilder.create("thing.enabled", Type.BOOLEAN)
                .withLabel("Thing Enabled")
                .withDescription("Enable/disable HomeKit integration for a thing")
                .withDefault("true")
                .build())
            .withParameter(ConfigDescriptionParameterBuilder.create("thing.type", Type.TEXT)
                .withLabel("Thing Type")
                .withDescription("The HomeKit type for this thing")
                .build())
            .withParameter(ConfigDescriptionParameterBuilder.create("channel.enabled", Type.BOOLEAN)
                .withLabel("Channel Enabled")
                .withDescription("Enable/disable HomeKit integration for a channel")
                .withDefault("true")
                .build())
            .withParameter(ConfigDescriptionParameterBuilder.create("channel.type", Type.TEXT)
                .withLabel("Channel Type")
                .withDescription("The HomeKit type for this channel")
                .build())
            .withParameter(ConfigDescriptionParameterBuilder.create("accessory.enabled", Type.BOOLEAN)
                .withLabel("Accessory Enabled")
                .withDescription("Enable/disable HomeKit integration for an accessory")
                .withDefault("true")
                .build())
            .withParameter(ConfigDescriptionParameterBuilder.create("accessory.type", Type.TEXT)
                .withLabel("Accessory Type")
                .withDescription("The HomeKit type for this accessory")
                .build())
            .build();
    }
} 