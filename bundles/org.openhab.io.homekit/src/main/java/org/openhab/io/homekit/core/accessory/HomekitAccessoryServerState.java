...
public class HomekitAccessoryServerState {
    ...
    private HomekitAccessoryServerState(String name, String description, HomekitEventType eventType, boolean isTransient) {
        this.name = name;
    ...
    public static final HomekitAccessoryServerState UNKNOWN = new HomekitAccessoryServerState("UNKNOWN", "Unknown state",
    ...
    public static final HomekitAccessoryServerState PAIRED = new HomekitAccessoryServerState("PAIRED", "Paired with controller",
    ...
    public static final HomekitAccessoryServerState MISSING_SETUP_CODE = new HomekitAccessoryServerState("MISSING_SETUP_CODE",
    ...
    public static final HomekitAccessoryServerState READY = new HomekitAccessoryServerState("READY", "Ready for operation",
            HomekitEventType.SERVER_STATE_CONNECTED, false);

    public static final HomekitAccessoryServerState STOPPED = new HomekitAccessoryServerState("STOPPED", "Server stopped",
            HomekitEventType.SERVER_STATE_CONNECTED, false);
    ...
    public static final HomekitAccessoryServerState PAIR_SETUP_INITIAL = new HomekitAccessoryServerState("PAIR_SETUP_INITIAL",
    ...
    public static final HomekitAccessoryServerState PAIR_SETUP_VERIFY = new HomekitAccessoryServerState("PAIR_SETUP_VERIFY",
            "Verifying pairing proof", HomekitEventType.SERVER_STATE_CONNECTED, true);

    public static final HomekitAccessoryServerState PAIR_SETUP_EXCHANGE = new HomekitAccessoryServerState("PAIR_SETUP_EXCHANGE",
