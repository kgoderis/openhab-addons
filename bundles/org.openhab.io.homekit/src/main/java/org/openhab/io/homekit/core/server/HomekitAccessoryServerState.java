...
public class HomekitAccessoryServerState {
        ...
        public static final HomekitAccessoryServerState PAIR_UNVERIFIED = new HomekitAccessoryServerState(
                        "PAIR_UNVERIFIED",
        ...
        public static final HomekitAccessoryServerState PAIRED_TO_OTHER_CONTROLLER = new HomekitAccessoryServerState(
                        ...
                        HomekitEventType.SERVER_STATE_PAIRED,
                        false);

        public static final HomekitAccessoryServerState PAIRING_MISSING = new HomekitAccessoryServerState(
                        "PAIRING_MISSING",
        ...
        public static final HomekitAccessoryServerState MISSING_SETUP_CODE = new HomekitAccessoryServerState(
                        "MISSING_SETUP_CODE", "Setup code is missing or invalid",
                        HomekitEventType.SERVER_STATE_MISSING_SETUP_CODE,
                        false);

        public static final HomekitAccessoryServerState AUTHENTICATING = new HomekitAccessoryServerState(
                        "AUTHENTICATING",
        ...
        public static final HomekitAccessoryServerState PAIR_SETUP_INITIAL = new HomekitAccessoryServerState(
                        "PAIR_SETUP_INITIAL", "Starting pair setup process", HomekitEventType.SERVER_STATE_CONNECTED,
                        true);

        public static final HomekitAccessoryServerState PAIR_SETUP_SRP = new HomekitAccessoryServerState(
                        "PAIR_SETUP_SRP",
        ...
        public static final HomekitAccessoryServerState PAIR_SETUP_EXCHANGE = new HomekitAccessoryServerState(
                        "PAIR_SETUP_EXCHANGE", "Exchanging encryption keys", HomekitEventType.SERVER_STATE_CONNECTED,
                        true);
