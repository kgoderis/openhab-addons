...
public class HomekitEventMetadata {
    ...
    public HomekitEventMetadata(HomekitEventMetadata original, @Nullable UID immediateOrigin) {
        ...
        this.eventHistory.addAll(original.eventHistory); // Copy original history (includes original eventId)
        this.eventHistory.add(original.eventId); // Add original eventId to the chain when forwarding
