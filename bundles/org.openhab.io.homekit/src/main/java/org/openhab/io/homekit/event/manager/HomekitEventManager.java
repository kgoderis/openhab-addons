...
public class HomekitEventManager {
    ...
    private Optional<HomekitEventSubscription> findExistingSubscription(HomekitEventType eventType, UID publisherUID,
        ...
        return subscriptions.stream().filter(sub -> sub.eventType.equals(eventType)
                && sub.publisherUID.equals(publisherUID) && sub.subscriber.equals(subscriber)).findFirst();
    }
    ...
    public int getSubscriberCount(HomekitEventType eventType) {
        return (int) subscriptions.stream().filter(sub -> sub.eventType.equals(eventType)).count();
    }
    ...
    public boolean hasSubscribers(HomekitEventType eventType) {
        return subscriptions.stream().anyMatch(sub -> sub.eventType.equals(eventType));
    }
