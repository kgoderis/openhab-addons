...
// private HomekitAccessoryServer server;
// private HomekitAccessory accessory;
// private final Map<Channel, @Nullable HomekitCharacteristic<?>> characteristicMap = new ConcurrentHashMap<>();
...
// public OldAccessoryThingHandler(Thing thing, HomekitAccessoryServerRegistry serverRegistry,
...
// private String getCharacteristicTag(HomekitCharacteristic<?> characteristic) throws HomekitException {
// try {
// Class<?> characteristicClass = characteristic.getClass();
// java.lang.reflect.HomekitMethod getTagMethod = characteristicClass.getMethod("getTag");
// return (String) getTagMethod.invoke(null);
// } catch (NoSuchMethodException | IllegalAccessException | java.lang.reflect.InvocationTargetException e) {
// throw new HomekitException(
// "HomekitCharacteristic " + characteristic.getClass().getName() + " does not implement getTag() method");
// }
// }
...
// if (event.getAccessory().equals(accessory)) {
// updateStatus(ThingStatus.OFFLINE, ThingStatusDetail.GONE, "HomekitAccessory was removed");
// }
// break;
// default:
// break;
...
// @Override
// public void onAccessoryEvent(HomekitAccessoryEvent accessoryEvent) {
...
// @Override
// public void onServiceEvent(HomekitServiceEvent serviceEvent) {
...
// private Channel addChannelForCharacteristic(HomekitCharacteristic<?> characteristic) {
// ChannelUID channelUID = new ChannelUID(thing.getUID(), characteristic.getUID().getHomekitId());
...
// private void removeChannelForCharacteristic(HomekitCharacteristic<?> characteristic) {
// ChannelUID channelUID = new ChannelUID(thing.getUID(), characteristic.getUID().getHomekitId());
// Channel channel = thing.getChannel(channelUID);
// if (channel != null) {
