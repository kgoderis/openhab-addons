...
import org.openhab.io.homekit.hap.impl.HomekitBridge;
import org.openhab.io.homekit.hap.impl.HomekitUtils;
import org.openhab.io.homekit.hap.impl.http.impl.HomekitHttpServer;
...
public class HomekitServer {
     ...
     * @throws IOException when mDNS cannot connect to the network
     */
    public HomekitRoot createBridge(HomekitAuthInfo authInfo, String label, String manufacturer, String model,
