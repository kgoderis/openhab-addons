...
public class LightbulbService extends AbstractServiceImpl {
    ...
    public LightbulbService(Lightbulb lightbulb, String serviceName) {
        ...
        addCharacteristic(new PowerStateCharacteristic(() -> lightbulb.getLightbulbPowerState(),
                v -> lightbulb.setLightbulbPowerState(v), c -> lightbulb.subscribeLightbulbPowerState(c),
