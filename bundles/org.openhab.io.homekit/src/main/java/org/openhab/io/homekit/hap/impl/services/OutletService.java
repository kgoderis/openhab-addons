...
public class OutletService extends AbstractServiceImpl {
    ...
    public OutletService(Outlet outlet, String serviceName) {
        ...
        addCharacteristic(new PowerStateCharacteristic(() -> outlet.getPowerState(), v -> outlet.setPowerState(v),
                c -> outlet.subscribePowerState(c), () -> outlet.unsubscribePowerState()));
