...
public class SwitchService extends AbstractServiceImpl {
    ...
    public SwitchService(Switch switchAccessory, String serviceName) {
        ...
        addCharacteristic(new PowerStateCharacteristic(() -> switchAccessory.getSwitchState(),
                v -> switchAccessory.setSwitchState(v), c -> switchAccessory.subscribeSwitchState(c),
