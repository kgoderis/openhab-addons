 ...
 */
@NonNullByDefault
public abstract class HomekitStringCharacteristic extends HomekitGenericCharacteristic<String> {
    ...
    public HomekitStringCharacteristic(HomekitService service, JsonValue value, HomekitEventManager eventManager) {
