...
public class AccessoryServerEvent {
    ...
    public enum AccessoryServerEventType {
        ...
        CHARACTERISTIC_STATE_CHANGED, SERVER_STATE_DISCONNECTED, SERVER_STATE_CONNECTED, SERVER_STATE_PAIRED, SERVER_STATE_PAIR_VERIFIED, SERVER_STATE_MISSING_SETUP_CODE, SERVER_STATE_PAIRING_MISSING, SERVER_STATE_UNPAIRED, SERVER_STATE_PAIR_UNVERIFIED
    }
