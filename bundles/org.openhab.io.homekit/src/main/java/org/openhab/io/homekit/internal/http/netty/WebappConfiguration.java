...
public class WebappConfiguration {
    ...
    public WebappConfiguration addHttpServlet(AccessoryServer server, HttpServlet servlet) {
        return this.addServletConfigurations(new ServletConfiguration(server, servlet));
    }

    public WebappConfiguration addHttpServlet(AccessoryServer server, HttpServlet servlet, String... urlPatterns) {
        return this.addServletConfigurations(new ServletConfiguration(server, servlet, urlPatterns));
    }

    public WebappConfiguration addHttpServlet(AccessoryServer server, Class<? extends HttpServlet> servletClass) {
        return this.addServletConfigurations(new ServletConfiguration(server, servletClass));
    }

    public WebappConfiguration addHttpServlet(AccessoryServer server, Class<? extends HttpServlet> servletClass,
            String... urlPatterns) {
        return this.addServletConfigurations(new ServletConfiguration(server, servletClass, urlPatterns));
    }
    ...
    public WebappConfiguration setStaticResourcesFolder(File folder) {
        ...
        if (!folder.exists()) {
            throw new IllegalArgumentException(
                    "Static resources folder '" + folder.getAbsolutePath() + "' was not found!");
        }
