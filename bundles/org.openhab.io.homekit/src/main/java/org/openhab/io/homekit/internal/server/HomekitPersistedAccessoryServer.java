...
public class HomekitPersistedAccessoryServer {
    ...
    public HomekitPersistedAccessoryServer(@NonNull InetAddress localAddress, int port, byte[] pairingId, byte[] privateKey,
            int configurationIndex, @NonNull Collection<@NonNull HomekitAccessory> accessories, HomekitAccessoryCategory category,
    ...
    public void setAccessories(@NonNull Collection<@NonNull HomekitAccessory> accessories) {
        if (accessories.isEmpty()) {
            this.accessories = "";
        } else {
