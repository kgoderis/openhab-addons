...
// public class HomekitThingAccessory extends AbstractManagedAccessory {

// protected static final Logger logger = LoggerFactory.getLogger(ThingAccessory.class);

// private ThingUID thingUID;

// public ThingAccessory(HomekitCommunicationManager manager, HomekitAccessoryServer server, long instanceId,
// boolean extend) {
...
// for (HomekitService aService : getServices()) {
