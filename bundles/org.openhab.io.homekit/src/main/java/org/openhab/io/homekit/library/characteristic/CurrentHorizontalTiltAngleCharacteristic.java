...
public class CurrentHorizontalTiltAngleCharacteristic extends IntegerCharacteristic {
    ...
    public CurrentHorizontalTiltAngleCharacteristic(Service service, long instanceId, HomekitEventManager eventManager) {
        super(service, instanceId, false, true, true, "Current Horizontal Tilt Angle", -90, 90, "arcdegrees", TYPE, eventManager);
    }

    public CurrentHorizontalTiltAngleCharacteristic(Service service, JsonValue value, HomekitEventManager eventManager) {
