 ...
 */
@HomekitCharacteristicType(type = "00000246-0000-1000-8000-0026BB765291", name = "CCA Energy Detect Threshold", tag = "ccaEnergyDetectThreshold")
@NonNullByDefault
public class HomekitCCAEnergyDetectThresholdCharacteristic extends HomekitIntegerCharacteristic {
    public HomekitCCAEnergyDetectThresholdCharacteristic(HomekitService service, HomekitEventManager eventManager, long instanceId) {
    ...
    public HomekitCCAEnergyDetectThresholdCharacteristic(HomekitService service, HomekitEventManager eventManager, JsonValue value) {
