 ...
 */
@HomekitCharacteristicType(type = "00000245-0000-1000-8000-0026BB765291", name = "CCA Signal Detect Threshold", tag = "ccaSignalDetectThreshold")
@NonNullByDefault
public class HomekitCCASignalDetectThresholdCharacteristic extends HomekitIntegerCharacteristic {
    public HomekitCCASignalDetectThresholdCharacteristic(HomekitService service, HomekitEventManager eventManager, long instanceId) {
    ...
    public HomekitCCASignalDetectThresholdCharacteristic(HomekitService service, HomekitEventManager eventManager, JsonValue value) {
