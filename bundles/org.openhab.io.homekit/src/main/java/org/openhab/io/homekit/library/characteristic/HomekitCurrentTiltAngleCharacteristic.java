 ...
 */
@HomekitCharacteristicType(type = "000000C1-0000-1000-8000-0026BB765291", name = "Current Tilt Angle", tag = "currentTiltAngle", acceptedItemTypes = {"Number", "Rollershutter"})
@NonNullByDefault
