 ...
 */
@HomekitCharacteristicType(type = "0000022B-0000-1000-8000-0026BB765291", name = "Current Transport", tag = "currentTransport")
@NonNullByDefault
public class HomekitCurrentTransportCharacteristic extends HomekitEnumCharacteristic {
    ...
    public HomekitCurrentTransportCharacteristic(HomekitService service, HomekitEventManager eventManager, long instanceId) {
    ...
    public HomekitCurrentTransportCharacteristic(HomekitService service, HomekitEventManager eventManager, JsonValue value) {
