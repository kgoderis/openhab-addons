 ...
 */
@HomekitCharacteristicType(type = "00000135-0000-1000-8000-0026BB765291", name = "Current Visibility State", tag = "currentVisibilityState", acceptedItemTypes = {"Number", "String"})
@NonNullByDefault
