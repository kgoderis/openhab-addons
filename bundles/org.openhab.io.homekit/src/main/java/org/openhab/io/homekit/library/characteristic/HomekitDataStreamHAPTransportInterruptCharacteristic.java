 ...
 */
@HomekitCharacteristicType(type = "00000139-0000-1000-8000-0026BB765291", name = "Data Stream HAP Transport Interrupt", tag = "dataStreamHAPTransportInterrupt", acceptedItemTypes = {
        "String" })
@NonNullByDefault
