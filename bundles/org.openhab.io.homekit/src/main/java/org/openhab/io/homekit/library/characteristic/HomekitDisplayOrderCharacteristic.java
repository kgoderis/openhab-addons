...
@NonNullByDefault
public class HomekitDisplayOrderCharacteristic extends HomekitTLV8Characteristic {
    public HomekitDisplayOrderCharacteristic(HomekitService service, HomekitEventManager eventManager, long instanceId) {
        super(service, eventManager);
        withInstanceId(instanceId)
            .withPairedRead(true)
            .withPairedWrite(true)
            .withEvents(true)
            .withDescription("Display Order");
    }

    public HomekitDisplayOrderCharacteristic(HomekitService service, HomekitEventManager eventManager, JsonValue value) {
