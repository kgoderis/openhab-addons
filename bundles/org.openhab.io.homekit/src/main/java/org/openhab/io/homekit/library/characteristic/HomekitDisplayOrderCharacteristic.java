 ...
 */
@HomekitCharacteristicType(type = "00000136-0000-1000-8000-0026BB765291", name = "Display Order", tag = "displayOrder", acceptedItemTypes = {"String"})
@NonNullByDefault
public class HomekitDisplayOrderCharacteristic extends HomekitTLV8Characteristic {
    public HomekitDisplayOrderCharacteristic(HomekitService service, HomekitEventManager eventManager,
            long instanceId) {
