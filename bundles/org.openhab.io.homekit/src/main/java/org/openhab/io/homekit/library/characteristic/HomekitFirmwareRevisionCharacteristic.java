...
public class HomekitFirmwareRevisionCharacteristic extends HomekitReadOnlyStringCharacteristic {
    public HomekitFirmwareRevisionCharacteristic(HomekitService service, HomekitEventManager eventManager, long instanceId) {
    ...
    public HomekitFirmwareRevisionCharacteristic(HomekitService service, HomekitEventManager eventManager, JsonValue value) {
