 ...
 */
@HomekitCharacteristicType(type = "00000234-0000-1000-8000-0026BB765291", name = "Firmware Update Readiness", tag = "firmwareUpdateReadiness")
@NonNullByDefault
public class HomekitFirmwareUpdateReadinessCharacteristic extends HomekitEnumCharacteristic {
    ...
    public HomekitFirmwareUpdateReadinessCharacteristic(HomekitService service, HomekitEventManager eventManager, long instanceId) {
    ...
    public HomekitFirmwareUpdateReadinessCharacteristic(HomekitService service, HomekitEventManager eventManager, JsonValue value) {
