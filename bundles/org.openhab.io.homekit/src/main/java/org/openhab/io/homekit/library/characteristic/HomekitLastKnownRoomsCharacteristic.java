...
/**
 * HomeKit Last Known Rooms Characteristic.
 * This characteristic represents the last known rooms in TLV8 format.
 *
 * @see <a href="https://developers.homebridge.io/#/characteristic/LastKnownRooms">HomeKit Documentation</a>
 */
@HomekitCharacteristicType(type = "0000024B-0000-1000-8000-0026BB765291", name = "Last Known Rooms", tag = "lastKnownRooms")
@NonNullByDefault
public class HomekitLastKnownRoomsCharacteristic extends HomekitTLV8Characteristic {
    public HomekitLastKnownRoomsCharacteristic(HomekitService service, HomekitEventManager eventManager, long instanceId) {
        super(service, eventManager);
        withInstanceId(instanceId)
            .withPairedRead(true)
            .withPairedWrite(false)
            .withEvents(true)
            .withDescription("Last Known Rooms");
    }

    public HomekitLastKnownRoomsCharacteristic(HomekitService service, HomekitEventManager eventManager, JsonValue value) {
