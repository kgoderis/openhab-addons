...
/**
 * HomeKit Last Known Rooms Update Reason Characteristic.
 * This characteristic represents the last known rooms update reason in TLV8 format.
 *
 * @see <a href="https://developers.homebridge.io/#/characteristic/LastKnownRoomsUpdateReason">HomeKit Documentation</a>
 */
@HomekitCharacteristicType(type = "00000250-0000-1000-8000-0026BB765291", name = "Last Known Rooms Update Reason", tag = "lastKnownRoomsUpdateReason")
@NonNullByDefault
public class HomekitLastKnownRoomsUpdateReasonCharacteristic extends HomekitTLV8Characteristic {
    public HomekitLastKnownRoomsUpdateReasonCharacteristic(HomekitService service, HomekitEventManager eventManager, long instanceId) {
        super(service, eventManager);
        withInstanceId(instanceId)
            .withPairedRead(true)
            .withPairedWrite(false)
            .withEvents(true)
            .withDescription("Last Known Rooms Update Reason");
    }

    public HomekitLastKnownRoomsUpdateReasonCharacteristic(HomekitService service, HomekitEventManager eventManager, JsonValue value) {
