 ...
 */
@HomekitCharacteristicType(type = "00000247-0000-1000-8000-0026BB765291", name = "MAC Retransmission Maximum", tag = "macRetransmissionMaximum")
@NonNullByDefault
public class HomekitMACRetransmissionMaximumCharacteristic extends HomekitIntegerCharacteristic {
    public HomekitMACRetransmissionMaximumCharacteristic(HomekitService service, HomekitEventManager eventManager, long instanceId) {
    ...
    public HomekitMACRetransmissionMaximumCharacteristic(HomekitService service, HomekitEventManager eventManager, JsonValue value) {
