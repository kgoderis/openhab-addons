...
@NonNullByDefault
public class HomekitModelCharacteristic extends HomekitReadOnlyStringCharacteristic {
    private static final String TYPE = "00000021-0000-1000-8000-0026BB765291";

    public HomekitModelCharacteristic(HomekitService service, long instanceId, HomekitEventManager eventManager) {
        super(service, instanceId, "Model", TYPE, eventManager);
    }

    public HomekitModelCharacteristic(HomekitService service, JsonValue value, HomekitEventManager eventManager) {
    ...
    public static String getTag() {
        return HomekitModelCharacteristic.class.getSimpleName().replace("HomekitCharacteristic", "");
    }
}
