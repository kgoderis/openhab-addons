 ...
 *
 * @see <a href="https://developers.homebridge.io/#/characteristic/NFCAccessSupportedConfiguration">HomeKit Documentation</a>
 */
...
public class HomekitNFCAccessSupportedConfigurationCharacteristic extends HomekitTLV8Characteristic {
    public HomekitNFCAccessSupportedConfigurationCharacteristic(HomekitService service, HomekitEventManager eventManager, long instanceId) {
    ...
    public HomekitNFCAccessSupportedConfigurationCharacteristic(HomekitService service, HomekitEventManager eventManager, JsonValue value) {
