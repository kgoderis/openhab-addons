...
/**
 * HomeKit Operating State Response Characteristic.
 * This characteristic represents the operating state response of the device.
 *
 * @see <a href="https://developers.homebridge.io/#/characteristic/OperatingStateResponse">HomeKit Documentation</a>
 */
@HomekitCharacteristicType(type = "00000232-0000-1000-8000-0026BB765291", name = "Operating State Response", tag = "operatingStateResponse")
@NonNullByDefault
public class HomekitOperatingStateResponseCharacteristic extends HomekitTLV8Characteristic {
    public HomekitOperatingStateResponseCharacteristic(HomekitService service, HomekitEventManager eventManager, long instanceId) {
        super(service, eventManager);
        withInstanceId(instanceId)
            .withPairedRead(true)
            .withPairedWrite(false)
            .withEvents(true)
            .withDescription("Operating State Response");
    }

    public HomekitOperatingStateResponseCharacteristic(HomekitService service, HomekitEventManager eventManager, JsonValue value) {
