...
public class HomekitOutletInUseCharacteristic extends HomekitBooleanCharacteristic {
    ...
    public HomekitOutletInUseCharacteristic(HomekitService service, long instanceId, HomekitEventManager eventManager) {
        super(service, instanceId, false, true, true, "Outlet In Use", TYPE, eventManager);
    }

    public HomekitOutletInUseCharacteristic(HomekitService service, JsonValue value, HomekitEventManager eventManager) {
    ...
    public static String getTag() {
        return HomekitOutletInUseCharacteristic.class.getSimpleName().replace("Characteristic", "");
    }
