...
public class HomekitPositionStateCharacteristic extends HomekitEnumCharacteristic {
    ...
    public HomekitPositionStateCharacteristic(HomekitService service, long instanceId, HomekitEventManager eventManager) {
        super(service, instanceId, false, true, true, "Position State", 2, TYPE, eventManager);
    }

    public HomekitPositionStateCharacteristic(HomekitService service, JsonValue value, HomekitEventManager eventManager) {
    ...
    public static String getTag() {
        return HomekitPositionStateCharacteristic.class.getSimpleName().replace("HomekitCharacteristic", "");
    }
