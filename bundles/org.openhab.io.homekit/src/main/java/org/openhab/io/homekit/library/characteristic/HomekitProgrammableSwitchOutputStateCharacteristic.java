...
public class HomekitProgrammableSwitchOutputStateCharacteristic extends HomekitBooleanCharacteristic {
    public HomekitProgrammableSwitchOutputStateCharacteristic(HomekitService service, HomekitEventManager eventManager, long instanceId) {
        super(service, eventManager);
        withInstanceId(instanceId).withPairedWrite(false).withPairedRead(true).withEvents(true)
            .withDescription("Programmable Switch Output State");
    }
    public HomekitProgrammableSwitchOutputStateCharacteristic(HomekitService service, HomekitEventManager eventManager, JsonValue value) {
