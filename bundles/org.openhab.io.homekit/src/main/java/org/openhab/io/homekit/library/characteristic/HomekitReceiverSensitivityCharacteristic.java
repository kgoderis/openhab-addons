 ...
 */
@HomekitCharacteristicType(type = "00000244-0000-1000-8000-0026BB765291", name = "Receiver Sensitivity", tag = "receiverSensitivity")
@NonNullByDefault
public class HomekitReceiverSensitivityCharacteristic extends HomekitIntegerCharacteristic {
    public HomekitReceiverSensitivityCharacteristic(HomekitService service, HomekitEventManager eventManager, long instanceId) {
    ...
    public HomekitReceiverSensitivityCharacteristic(HomekitService service, HomekitEventManager eventManager, JsonValue value) {
