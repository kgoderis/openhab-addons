...
public class HomekitRelayEnabledCharacteristic extends HomekitBooleanCharacteristic {
    ...
    public HomekitRelayEnabledCharacteristic(HomekitService service, HomekitEventManager eventManager, long instanceId) {
    ...
    public HomekitRelayEnabledCharacteristic(HomekitService service, HomekitEventManager eventManager, JsonValue value) {
