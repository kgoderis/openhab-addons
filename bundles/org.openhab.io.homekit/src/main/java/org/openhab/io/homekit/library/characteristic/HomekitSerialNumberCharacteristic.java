...
public class HomekitSerialNumberCharacteristic extends HomekitReadOnlyStringCharacteristic {
    public HomekitSerialNumberCharacteristic(HomekitService service, HomekitEventManager eventManager, long instanceId) {
    ...
    public HomekitSerialNumberCharacteristic(HomekitService service, HomekitEventManager eventManager, JsonValue value) {
