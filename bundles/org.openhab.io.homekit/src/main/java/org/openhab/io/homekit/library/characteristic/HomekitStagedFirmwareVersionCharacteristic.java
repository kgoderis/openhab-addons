 ...
 */
@HomekitCharacteristicType(type = "00000249-0000-1000-8000-0026BB765291", name = "Staged Firmware Version", tag = "stagedFirmwareVersion")
@NonNullByDefault
public class HomekitStagedFirmwareVersionCharacteristic extends HomekitStringCharacteristic {
    public HomekitStagedFirmwareVersionCharacteristic(HomekitService service, HomekitEventManager eventManager, long instanceId) {
    ...
    public HomekitStagedFirmwareVersionCharacteristic(HomekitService service, HomekitEventManager eventManager, JsonValue value) {
