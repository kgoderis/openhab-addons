...
public class HomekitStatusFaultCharacteristic extends HomekitEnumCharacteristic {
    ...
    public HomekitStatusFaultCharacteristic(HomekitService service, long instanceId, HomekitEventManager eventManager) {
        super(service, instanceId, false, true, true, "Status Fault", 1, TYPE, eventManager);
    }

    public HomekitStatusFaultCharacteristic(HomekitService service, JsonValue value, HomekitEventManager eventManager) {
    ...
    public static String getTag() {
        return HomekitStatusFaultCharacteristic.class.getSimpleName().replace("HomekitCharacteristic", "");
    }
