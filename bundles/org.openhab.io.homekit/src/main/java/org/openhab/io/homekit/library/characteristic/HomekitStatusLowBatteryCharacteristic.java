...
public class HomekitStatusLowBatteryCharacteristic extends HomekitEnumCharacteristic {
    ...
    public HomekitStatusLowBatteryCharacteristic(HomekitService service, long instanceId, HomekitEventManager eventManager) {
        super(service, instanceId, false, true, true, "Status Low Battery", 1, TYPE, eventManager);
    }

    public HomekitStatusLowBatteryCharacteristic(HomekitService service, JsonValue value, HomekitEventManager eventManager) {
    ...
    public static String getTag() {
        return HomekitStatusLowBatteryCharacteristic.class.getSimpleName().replace("HomekitCharacteristic", "");
    }
