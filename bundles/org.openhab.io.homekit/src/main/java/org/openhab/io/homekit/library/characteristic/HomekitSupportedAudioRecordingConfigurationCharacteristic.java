...
/**
 * HomeKit Supported Audio Recording Configuration Characteristic.
 * This characteristic represents the supported configuration for audio recording, as defined in the HomeKit Accessory Protocol (HAP) specification.
 *
 * @author Karel Goderis - Initial Contribution
 * @see <a href="https://developer.apple.com/documentation/HomeKit">HAP Specification</a>
 */
@HomekitCharacteristicType(type = "00000207-0000-1000-8000-0026BB765291", name = "Supported Audio Recording Configuration", tag = "supportedAudioRecordingConfiguration")
@NonNullByDefault
public class HomekitSupportedAudioRecordingConfigurationCharacteristic extends HomekitTLV8Characteristic {
    /**
     * Constructs a new Supported Audio Recording Configuration characteristic.
     *
     * @param service the HomeKit service this characteristic belongs to
     * @param eventManager the event manager for handling HomeKit events
     * @param instanceId the instance ID for this characteristic
     */
    public HomekitSupportedAudioRecordingConfigurationCharacteristic(HomekitService service, HomekitEventManager eventManager, long instanceId) {
        super(service, eventManager);
        withInstanceId(instanceId)
            .withPairedRead(true)
            .withPairedWrite(false)
            .withEvents(true)
            .withDescription("Supported Audio Recording Configuration");
    }

    /**
     * Constructs a new Supported Audio Recording Configuration characteristic from a JSON value.
     *
     * @param service the HomeKit service this characteristic belongs to
     * @param eventManager the event manager for handling HomeKit events
     * @param value the JSON value to initialize the characteristic with
     */
    public HomekitSupportedAudioRecordingConfigurationCharacteristic(HomekitService service, HomekitEventManager eventManager, JsonValue value) {
