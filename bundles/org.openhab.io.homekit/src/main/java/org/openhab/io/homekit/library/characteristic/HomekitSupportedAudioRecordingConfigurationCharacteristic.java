 ...
 * This characteristic represents the supported configuration for audio recording, as defined in the HomeKit Accessory
 * Protocol (HAP) specification.
 *
 * @author Karel Goderis - Initial Contribution
 * @see <a href="https://developer.apple.com/documentation/HomeKit">HAP Specification</a>
 */
@HomekitCharacteristicType(type = "00000207-0000-1000-8000-0026BB765291", name = "Supported Audio Recording Configuration", tag = "supportedAudioRecordingConfiguration", acceptedItemTypes = {"String"})
@NonNullByDefault
public class HomekitSupportedAudioRecordingConfigurationCharacteristic extends HomekitTLV8Characteristic {
     ...
     */
    public HomekitSupportedAudioRecordingConfigurationCharacteristic(HomekitService service,
