 ...
 */
@HomekitCharacteristicType(type = "00000144-0000-1000-8000-0026BB765291", name = "Supported Characteristic Value Transition Configuration", tag = "supportedCharacteristicValueTransitionConfiguration", acceptedItemTypes = {"String"})
@NonNullByDefault
public class HomekitSupportedCharacteristicValueTransitionConfigurationCharacteristic
    ...
    /**
     * Constructs a new Supported Characteristic Value Transition Configuration characteristic from a JSON value.
     *
     * @param service the HomeKit service this characteristic belongs to
     * @param eventManager the event manager for handling HomeKit events
