 ...
 */
@HomekitCharacteristicType(type = "00000144-0000-1000-8000-0026BB765291", name = "Supported Characteristic Value Transition Configuration", tag = "supportedCharacteristicValueTransitionConfiguration", acceptedItemTypes = {
        "String" })
@NonNullByDefault
