...
/**
 * HomeKit Supported Firmware Update Configuration Characteristic.
 * This characteristic represents the supported firmware update configuration options.
 *
 * @see <a href="https://developers.homebridge.io/#/characteristic/SupportedFirmwareUpdateConfiguration">HomeKit Documentation</a>
 */
@HomekitCharacteristicType(type = "00000233-0000-1000-8000-0026BB765291", name = "Supported Firmware Update Configuration", tag = "supportedFirmwareUpdateConfiguration")
@NonNullByDefault
public class HomekitSupportedFirmwareUpdateConfigurationCharacteristic extends HomekitTLV8Characteristic {
    public HomekitSupportedFirmwareUpdateConfigurationCharacteristic(HomekitService service, HomekitEventManager eventManager, long instanceId) {
        super(service, eventManager);
        withInstanceId(instanceId)
            .withPairedRead(true)
            .withPairedWrite(false)
            .withEvents(true)
            .withDescription("Supported Firmware Update Configuration");
    }

    public HomekitSupportedFirmwareUpdateConfigurationCharacteristic(HomekitService service, HomekitEventManager eventManager, JsonValue value) {
