 ...
 *
 * @see <a href="https://developers.homebridge.io/#/characteristic/SupportedFirmwareUpdateConfiguration">HomeKit
 *      Documentation</a>
 */
@HomekitCharacteristicType(type = "00000233-0000-1000-8000-0026BB765291", name = "Supported Firmware Update Configuration", tag = "supportedFirmwareUpdateConfiguration", acceptedItemTypes = {"String"})
@NonNullByDefault
public class HomekitSupportedFirmwareUpdateConfigurationCharacteristic extends HomekitTLV8Characteristic {
    public HomekitSupportedFirmwareUpdateConfigurationCharacteristic(HomekitService service,
