 ...
 * <p>
 * This characteristic represents the supported RTP configuration for a device, using TLV8 encoding as defined by the HAP specification.
 * <p>
 * See the HomeKit Accessory Protocol (HAP) specification for details: https://developer.apple.com/documentation/HomeKit
 *
 * @author Karel Goderis
 */
@HomekitCharacteristicType(type = "00000116-0000-1000-8000-0026BB765291", name = "Supported RTP Configuration", tag = "supportedRTPConfiguration")
@NonNullByDefault
public class HomekitSupportedRTPConfigurationCharacteristic extends HomekitTLV8Characteristic {
    public HomekitSupportedRTPConfigurationCharacteristic(HomekitService service, HomekitEventManager eventManager, long instanceId) {
        super(service, eventManager);
        withInstanceId(instanceId)
            .withPairedRead(true)
            .withDescription("Supported RTP Configuration");
    }

    public HomekitSupportedRTPConfigurationCharacteristic(HomekitService service, HomekitEventManager eventManager, JsonValue value) {
