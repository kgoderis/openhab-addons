 ...
 * This characteristic represents the supported configuration for transfer transport, as defined in the HomeKit Accessory Protocol (HAP) specification.
 *
 * @author Karel Goderis - Initial Contribution
 * @see <a href="https://developer.apple.com/documentation/HomeKit">HAP Specification</a>
 */
@HomekitCharacteristicType(type = "00000202-0000-1000-8000-0026BB765291", name = "Supported Transfer Transport Configuration", tag = "supportedTransferTransportConfiguration")
@NonNullByDefault
public class HomekitSupportedTransferTransportConfigurationCharacteristic extends HomekitTLV8Characteristic {
     ...
     */
    public HomekitSupportedTransferTransportConfigurationCharacteristic(HomekitService service, HomekitEventManager eventManager, long instanceId) {
     ...
     */
    public HomekitSupportedTransferTransportConfigurationCharacteristic(HomekitService service, HomekitEventManager eventManager, JsonValue value) {
