...
/**
 * HomeKit Target Control List Characteristic.
 * <p>
 * This characteristic represents the target control list for a device, using TLV8 encoding as defined by the HAP specification.
 * <p>
 * See the HomeKit Accessory Protocol (HAP) specification for details: https://developer.apple.com/documentation/HomeKit
 *
 * @author Karel Goderis
 */
@HomekitCharacteristicType(type = "00000124-0000-1000-8000-0026BB765291", name = "Target Control List", tag = "targetControlList")
@NonNullByDefault
public class HomekitTargetControlListCharacteristic extends HomekitTLV8Characteristic {

    public HomekitTargetControlListCharacteristic(HomekitService service, HomekitEventManager eventManager, long instanceId) {
        super(service, eventManager);
        withInstanceId(instanceId)
            .withPairedRead(true)
            .withDescription("Target Control List");
    }

    public HomekitTargetControlListCharacteristic(HomekitService service, HomekitEventManager eventManager, JsonValue value) {
