 ...
 * <p>
 * This characteristic represents the target control list for a device, using TLV8 encoding as defined by the HAP
 * specification.
 * <p>
 ...
 */
@HomekitCharacteristicType(type = "00000124-0000-1000-8000-0026BB765291", name = "Target Control List", tag = "targetControlList", acceptedItemTypes = {"String"})
@NonNullByDefault
public class HomekitTargetControlListCharacteristic extends HomekitTLV8Characteristic {
    ...
    public HomekitTargetControlListCharacteristic(HomekitService service, HomekitEventManager eventManager,
        ...
        withInstanceId(instanceId).withPairedRead(true).withDescription("Target Control List");
    }
