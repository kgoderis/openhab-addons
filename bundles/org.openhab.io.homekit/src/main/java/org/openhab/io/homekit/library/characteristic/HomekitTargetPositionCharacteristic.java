...
public class HomekitTargetPositionCharacteristic extends HomekitIntegerCharacteristic {
    ...
    public HomekitTargetPositionCharacteristic(HomekitService service, long instanceId, HomekitEventManager eventManager) {
        super(service, instanceId, true, true, true, "Target Position", 0, 100, "%", TYPE, eventManager);
    }

    public HomekitTargetPositionCharacteristic(HomekitService service, JsonValue value, HomekitEventManager eventManager) {
    ...
    public static String getTag() {
        return HomekitTargetPositionCharacteristic.class.getSimpleName().replace("HomekitCharacteristic", "");
    }
