 ...
 */
@HomekitCharacteristicType(type = "00000704-0000-1000-8000-0026BB765291", name = "Thread Control Point", tag = "threadControlPoint", acceptedItemTypes = {"String"})
@NonNullByDefault
public class HomekitThreadControlPointCharacteristic extends HomekitTLV8Characteristic {
    public HomekitThreadControlPointCharacteristic(HomekitService service, HomekitEventManager eventManager,
            long instanceId) {
        super(service, eventManager);
        withInstanceId(instanceId).withPairedRead(true).withPairedWrite(true).withEvents(true)
                .withDescription("Thread Control Point");
    }
