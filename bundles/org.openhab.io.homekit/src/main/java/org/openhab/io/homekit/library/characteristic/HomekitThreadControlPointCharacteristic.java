...
public class HomekitThreadControlPointCharacteristic extends HomekitTLV8Characteristic {
    public HomekitThreadControlPointCharacteristic(HomekitService service, HomekitEventManager eventManager, long instanceId) {
    ...
    public HomekitThreadControlPointCharacteristic(HomekitService service, HomekitEventManager eventManager, JsonValue value) {
