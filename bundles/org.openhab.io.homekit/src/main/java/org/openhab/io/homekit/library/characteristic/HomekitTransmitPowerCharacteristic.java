 ...
 */
@HomekitCharacteristicType(type = "00000242-0000-1000-8000-0026BB765291", name = "Transmit Power", tag = "transmitPower")
@NonNullByDefault
public class HomekitTransmitPowerCharacteristic extends HomekitIntegerCharacteristic {
    public HomekitTransmitPowerCharacteristic(HomekitService service, HomekitEventManager eventManager, long instanceId) {
    ...
    public HomekitTransmitPowerCharacteristic(HomekitService service, HomekitEventManager eventManager, JsonValue value) {
