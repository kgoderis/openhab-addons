 ...
 */
@HomekitCharacteristicType(type = "0000022D-0000-1000-8000-0026BB765291", name = "WiFi Configuration Control", tag = "wifiConfigurationControl")
@NonNullByDefault
public class HomekitWiFiConfigurationControlCharacteristic extends HomekitTLV8Characteristic {
    public HomekitWiFiConfigurationControlCharacteristic(HomekitService service, HomekitEventManager eventManager, long instanceId) {
    ...
    public HomekitWiFiConfigurationControlCharacteristic(HomekitService service, HomekitEventManager eventManager, JsonValue value) {
