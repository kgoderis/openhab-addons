...
public class ObstructionDetectedCharacteristic extends BooleanCharacteristic {
    ...
    public ObstructionDetectedCharacteristic(Service service, long instanceId, HomekitEventManager eventManager) {
        super(service, instanceId, false, true, true, "Obstruction Detected", TYPE, eventManager);
    }

    public ObstructionDetectedCharacteristic(Service service, JsonValue value, HomekitEventManager eventManager) {
