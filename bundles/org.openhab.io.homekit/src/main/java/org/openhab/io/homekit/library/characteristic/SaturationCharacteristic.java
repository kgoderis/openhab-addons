...
public class SaturationCharacteristic extends FloatCharacteristic {
    ...
    public SaturationCharacteristic(Service service, long instanceId, HomekitEventManager eventManager) {
        super(service, instanceId, true, true, true, "Adjust saturation of the light", 0, 100, 1, "percentage", TYPE, eventManager);
    }

    public SaturationCharacteristic(Service service, JsonValue value, HomekitEventManager eventManager) {
