...
public class ServiceNameCharacteristic extends ReadOnlyStringCharacteristic {
    ...
    public ServiceNameCharacteristic(Service service, long instanceId, HomekitEventManager eventManager) {
        super(service, instanceId, "Service Name", TYPE, eventManager);
    }

    public ServiceNameCharacteristic(Service service, JsonValue value, HomekitEventManager eventManager) {
