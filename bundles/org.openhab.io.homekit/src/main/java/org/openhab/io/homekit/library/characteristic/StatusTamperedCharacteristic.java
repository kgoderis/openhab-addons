...
public class StatusTamperedCharacteristic extends EnumCharacteristic {
    ...
    public StatusTamperedCharacteristic(Service service, long instanceId, HomekitEventManager eventManager) {
        super(service, instanceId, false, true, true, "Status Tampered", 1, TYPE, eventManager);
    }

    public StatusTamperedCharacteristic(Service service, JsonValue value, HomekitEventManager eventManager) {
