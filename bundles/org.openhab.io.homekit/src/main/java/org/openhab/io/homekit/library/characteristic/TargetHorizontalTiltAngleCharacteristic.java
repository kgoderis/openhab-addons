...
public class TargetHorizontalTiltAngleCharacteristic extends IntegerCharacteristic {
    ...
    public TargetHorizontalTiltAngleCharacteristic(Service service, long instanceId, HomekitEventManager eventManager) {
        super(service, instanceId, true, true, true, "Target Horizontal Tilt Angle", -90, 90, "arcdegrees", TYPE, eventManager);
    }

    public TargetHorizontalTiltAngleCharacteristic(Service service, JsonValue value, HomekitEventManager eventManager) {
