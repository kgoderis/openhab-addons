...
public class DimmableLightBulbService extends GenericService {
    private static final String TYPE = "00000043-0000-1000-8000-0026BB765291";

    public DimmableLightBulbService(Accessory accessory, long instanceId, boolean extend, @NonNull String serviceName, HomekitEventManager eventManager, Collection<HomekitFactory> factories)
            {
        super(accessory, instanceId, extend, serviceName, TYPE, eventManager, factories);
    }

    public DimmableLightBulbService(Accessory accessory, JsonValue value, String name, HomekitEventManager eventManager, Collection<HomekitFactory> factories) {
