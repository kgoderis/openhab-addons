...
@HomekitServiceType(type = "00000097-0000-1000-8000-0026BB765291", name = "CarbonDioxideSensor", tag = "CarbonDioxideSensor")
public class HomekitCarbonDioxideSensorService extends AbstractHomekitService {
    ...
    public void addCharacteristics() {
        ...
        addCharacteristic(new HomekitCarbonDioxideDetectedCharacteristic(this,
