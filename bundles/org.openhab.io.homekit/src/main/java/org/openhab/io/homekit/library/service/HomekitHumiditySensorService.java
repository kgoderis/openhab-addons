...
/**
 * Service that represents a humidity sensor in HomeKit.
 * This service provides information about relative humidity levels.
 *
...
public class HomekitHumiditySensorService extends AbstractHomekitService {
    ...
    /**
     * Creates a new HomekitHumiditySensorService.
     *
    ...
    /**
     * Creates a new HomekitHumiditySensorService from a JSON value.
     *
     * @param accessory The accessory this service belongs to
     * @param eventManager The event manager for handling HomeKit events
     * @param characteristicFactory Factory for creating HomeKit characteristics
