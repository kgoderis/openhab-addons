...
public class HomekitLightBulbService extends HomekitGenericService {
    private static final String TYPE = "00000043-0000-1000-8000-0026BB765291";

    public HomekitLightBulbService(HomekitAccessory accessory, long instanceId, boolean extend, @NonNull String serviceName, HomekitEventManager eventManager, Collection<HomekitFactory> factories)
             {
        super(accessory, instanceId, extend, serviceName, TYPE, eventManager, factories);
    }

    public HomekitLightBulbService(HomekitAccessory accessory, JsonValue value, String name, HomekitEventManager eventManager, Collection<HomekitFactory> factories) {
    ...
    public static String getTag() {
        return HomekitLightBulbService.class.getSimpleName().replace("HomekitService", "");
    }
}
