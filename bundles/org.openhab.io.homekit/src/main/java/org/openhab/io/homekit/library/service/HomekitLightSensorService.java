...
public class HomekitLightSensorService extends AbstractHomekitService {
        ...
        private static final Logger logger = LoggerFactory.getLogger(HomekitLightSensorService.class);
        ...
        public HomekitLightSensorService(HomekitAccessory accessory, HomekitEventManager eventManager,
                ...
                withName("Light Sensor").withPrimary(false).withHidden(false).withExtensible(false);
