...
public class HomekitLockMechanismService extends AbstractHomekitService {
        ...
        public HomekitLockMechanismService(HomekitAccessory accessory, HomekitEventManager eventManager,
                ...
                withName("Lock Mechanism").withPrimary(false).withHidden(false).withExtensible(false);
        ...
        public HomekitLockMechanismService(HomekitAccessory accessory, HomekitEventManager eventManager,
                ...
                logger.debug("{}Created LockMechanismService from JSON for accessory {}", LOG_INIT,
                                accessory.getLabel());
        }
        ...
        public void addCharacteristics() throws HomekitServiceException {
                ...
                addCharacteristic(
                                new HomekitStatusJammedCharacteristic(this, eventManager,
                                                getAccessory().getNextAvailableInstanceId())
                                                .withMandatory(false));
                ...
                logger.debug("{}Added characteristics for Lock Mechanism service", LOG_CONFIG);
        }
}
