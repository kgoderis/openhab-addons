...
public class HomekitOutletService extends HomekitBaseService {
    ...
    public HomekitOutletService(HomekitAccessory accessory, JsonValue value, String name, HomekitEventManager eventManager, Collection<HomekitFactory> factories) {
    ...
    public void addCharacteristics() {
        ...
        addCharacteristic(new HomekitOutletInUseCharacteristic(this, ((HomekitAccessory) getAccessory()).getNextAvailableInstanceId(),
                eventManager));
    }
    ...
    public static String getTag() {
        return HomekitOutletService.class.getSimpleName().replace("HomekitService", "");
    }
}
