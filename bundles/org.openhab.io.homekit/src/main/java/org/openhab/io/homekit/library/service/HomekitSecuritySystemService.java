...
public class HomekitSecuritySystemService extends AbstractHomekitService {
        ...
        public HomekitSecuritySystemService(HomekitAccessory accessory, HomekitEventManager eventManager,
                ...
                withName("Security System").withPrimary(false).withHidden(false).withExtensible(false);
        ...
        public HomekitSecuritySystemService(HomekitAccessory accessory, HomekitEventManager eventManager,
                ...
                logger.debug("{}Created SecuritySystemService from JSON for accessory {}", LOG_INIT,
                                accessory.getLabel());
        }
        ...
        public void addCharacteristics() throws HomekitServiceException {
                ...
                logger.debug("{}Added characteristics for Security System service", LOG_CONFIG);
        }
}
