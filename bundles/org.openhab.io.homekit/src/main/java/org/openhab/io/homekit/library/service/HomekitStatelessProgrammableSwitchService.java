...
public class HomekitStatelessProgrammableSwitchService extends AbstractHomekitService {
        ...
        public HomekitStatelessProgrammableSwitchService(HomekitAccessory accessory, HomekitEventManager eventManager,
                ...
                logger.debug("{}Created StatelessProgrammableSwitchService for accessory {}", LOG_INIT,
                                accessory.getLabel());
        }
        ...
        public HomekitStatelessProgrammableSwitchService(HomekitAccessory accessory, HomekitEventManager eventManager,
                ...
                logger.debug("{}Created StatelessProgrammableSwitchService from JSON configuration for accessory {}",
                                LOG_INIT,
                                accessory.getLabel());
        }
