 ...
 * This service provides transfer transport management functionality in HomeKit.
 * For more information, see https://developer.apple.com/documentation/HomeKit
 *
 * @author Karel Goderis
 */
@HomekitServiceType(type = "00000203-0000-1000-8000-0026BB765291", name = "TransferTransportManagement", tag = "transferTransportManagement")
@NonNullByDefault
public class HomekitTransferTransportManagementService extends AbstractHomekitService {
    /**
    ...
    /**
     * Creates a new Transfer Transport Management service from a JSON configuration.
     *
     * @param accessory The accessory this service belongs to
     * @param eventManager The event manager for handling HomeKit events
     * @param characteristicFactory Factory for creating HomeKit characteristics
     ...
     * Required: SupportedTransferTransportConfiguration, SetupTransferTransport
     */
    @Override
    public void addCharacteristics() throws HomekitServiceException {
        // Required characteristics
        addCharacteristic(new HomekitSupportedTransferTransportConfigurationCharacteristic(this, eventManager,
                getAccessory().getNextAvailableInstanceId()).withMandatory(true));
        addCharacteristic(new HomekitSetupTransferTransportCharacteristic(this, eventManager,
                getAccessory().getNextAvailableInstanceId()).withMandatory(true));
    }
}
