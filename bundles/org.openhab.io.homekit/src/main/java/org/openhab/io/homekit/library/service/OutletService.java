...
public class OutletService extends AbstractService {
    ...
    public OutletService(HomekitCommunicationManager manager, Accessory accessory, long instanceId, boolean extend,
    ...
    public void addCharacteristics() throws Exception {
        ...
        addCharacteristic(new OutletInUseCharacteristic(manager, this, this.getAccessory().getInstanceId()));
    }
