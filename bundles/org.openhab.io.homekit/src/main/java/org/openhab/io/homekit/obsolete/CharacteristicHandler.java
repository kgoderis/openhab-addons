...
// Collection<ManagedService> services = theAccessory.getServices();
//
// for (ManagedService aService : services) {
// ManagedCharacteristic<?> characteristic = aService.getCharacteristic(iid);
