...
public abstract class HomekitAbstractAccessoryServer implements HomekitAccessoryServer, AutoCloseable {
    ...
    private static final Map<HomekitAccessoryServerState, Set<HomekitAccessoryServerState>> VALID_STATE_TRANSITIONS = Map
            .ofEntries(Map.entry(HomekitAccessoryServerState.UNKNOWN, Set.of(HomekitAccessoryServerState.READY)),
                    Map.entry(HomekitAccessoryServerState.READY,
                            Set.of(HomekitAccessoryServerState.STOPPED, HomekitAccessoryServerState.CONNECTED)),
                    Map.entry(HomekitAccessoryServerState.CONNECTED,
                            Set.of(HomekitAccessoryServerState.DISCONNECTED,
                                    HomekitAccessoryServerState.PAIR_SETUP_INITIAL)),
                    Map.entry(HomekitAccessoryServerState.DISCONNECTED,
                    ...
                    Map.entry(HomekitAccessoryServerState.PAIR_SETUP_INITIAL,
                            Set.of(HomekitAccessoryServerState.PAIR_SETUP_SRP, HomekitAccessoryServerState.PAIRED,
                                    HomekitAccessoryServerState.DISCONNECTED, HomekitAccessoryServerState.UNPAIRED,
                                    HomekitAccessoryServerState.MISSING_SETUP_CODE)),
                    Map.entry(HomekitAccessoryServerState.PAIR_SETUP_SRP,
                            Set.of(HomekitAccessoryServerState.PAIR_SETUP_VERIFY, HomekitAccessoryServerState.PAIRED,
                                    HomekitAccessoryServerState.DISCONNECTED, HomekitAccessoryServerState.UNPAIRED)),
                    Map.entry(HomekitAccessoryServerState.PAIR_SETUP_VERIFY,
                            Set.of(HomekitAccessoryServerState.PAIR_SETUP_EXCHANGE, HomekitAccessoryServerState.PAIRED,
                                    HomekitAccessoryServerState.DISCONNECTED, HomekitAccessoryServerState.UNPAIRED)),
                    Map.entry(HomekitAccessoryServerState.PAIR_SETUP_EXCHANGE,
                            Set.of(HomekitAccessoryServerState.PAIR_UNVERIFIED, HomekitAccessoryServerState.PAIRED,
                                    HomekitAccessoryServerState.DISCONNECTED, HomekitAccessoryServerState.UNPAIRED)),
                    Map.entry(HomekitAccessoryServerState.PAIRED,
                            Set.of(HomekitAccessoryServerState.PAIR_UNVERIFIED,
                                    HomekitAccessoryServerState.DISCONNECTED)),
                    Map.entry(HomekitAccessoryServerState.PAIR_UNVERIFIED,
                            Set.of(HomekitAccessoryServerState.PAIR_VERIFIED,
                                    HomekitAccessoryServerState.DISCONNECTED)),
                    Map.entry(HomekitAccessoryServerState.PAIR_VERIFIED,
                            Set.of(HomekitAccessoryServerState.PAIR_UNVERIFIED,
                                    HomekitAccessoryServerState.DISCONNECTED)),
                    Map.entry(HomekitAccessoryServerState.UNPAIRED,
                            Set.of(HomekitAccessoryServerState.PAIR_SETUP_INITIAL,
                                    HomekitAccessoryServerState.DISCONNECTED,
                                    HomekitAccessoryServerState.MISSING_SETUP_CODE)),
                    Map.entry(HomekitAccessoryServerState.MISSING_SETUP_CODE,
                            Set.of(HomekitAccessoryServerState.PAIR_SETUP_INITIAL,
                                    HomekitAccessoryServerState.DISCONNECTED, HomekitAccessoryServerState.UNPAIRED)),
                    Map.entry(HomekitAccessoryServerState.STOPPED, Set.of(HomekitAccessoryServerState.READY)));
