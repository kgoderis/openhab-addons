...
public class UUID5 {
    ...
    public static final UUID NAMESPACE_OPENHAB = UUID5.fromNamespaceAndString(NAMESPACE_HOMEKIT, "openhab.org");
    public static final UUID NAMESPACE_SERVICE = UUID5.fromNamespaceAndString(NAMESPACE_OPENHAB, "Service");
    public static final UUID NAMESPACE_CHARACTERISTIC = UUID5.fromNamespaceAndString(NAMESPACE_OPENHAB,
            "Characteristic");
