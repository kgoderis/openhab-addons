...
import org.openhab.io.homekit.internal.bridge.HomekitAccessoryType;
...
import org.openhab.io.homekit.v1.internal.HomekitException;
        ...
        switch (taggedItem.getAccessoryType()) {
            ...
            case THERMOSTAT:
                HomekitTaggedItem temperatureAccessory = getPrimaryAccessory(taggedItem,
                        ...
                        .orElseThrow(() -> new HomekitException("Thermostats need a CurrentTemperature accessory"));
