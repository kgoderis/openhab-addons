...
def main():
    """Test function to process 10 specific files"""
    # Test files - more files that don't already have @NonNullByDefault
    test_files = [
        'src/main/java/org/openhab/io/homekit/handler/HomekitAccessoryThingHandler.java',
        'src/main/java/org/openhab/io/homekit/handler/AbstractHomekitHandler.java',
        'src/main/java/org/openhab/io/homekit/handler/HomekitServiceThingHandler.java',
        'src/main/java/org/openhab/io/homekit/core/characteristic/HomekitCharacteristicUIDImpl.java',
        'src/main/java/org/openhab/io/homekit/core/characteristic/HomekitReadOnlyBooleanCharacteristic.java',
        'src/main/java/org/openhab/io/homekit/core/characteristic/HomekitFloatCharacteristic.java',
        'src/main/java/org/openhab/io/homekit/core/characteristic/HomekitWriteOnlyBooleanCharacteristic.java',
        'src/main/java/org/openhab/io/homekit/core/characteristic/HomekitShortReadOnlyStringCharacteristic.java'
    ]
